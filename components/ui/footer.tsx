            ...
            <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
                <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            ...
                            <ul className="mt-6 space-y-4 text-sm">
                                {
                                    navItems.map((item) => (
                                        <li key={item.name}>
                                            <a href={item.link} className="text-gray-700 transition hover:opacity-75"> {item.name} </a>
                                        </li>
                                    ))
                                }
                            </ul>
                        ...
                        {/* 
                        <div>
                            <p className="font-medium text-gray-900">The Hype Company</p>
                ...
                <div className="mt-12 border-t border-gray-100 pt-12">
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <ul className="flex flex-wrap gap-4 text-xs">
                            ...
                            <li>
                                <a href="#" className="text-gray-500 transition hover:opacity-75"> Politica de Privacidad </a>
                            </li>
                        ...
                        <p className="mt-8 text-xs text-gray-500 sm:mt-0">
                            &copy; {new Date().getFullYear()}. The Hype Company. Todos los derechos reservados.
                        </p>
                    </div>
                </div>
            </div>
