                ...
                <div className="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
                    <div className="relative isolate overflow-hidden bg-white-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
                        ...
                        <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
                            <h2 className="text-3xl font-bold tracking-tight text-black sm:text-4xl">Se parte de la compañia, se parde de <i>{StoreInfo.name}</i>.</h2>
                            <p className="mt-6 text-lg leading-8 text-black-300">{StoreInfo.description}</p>
                        ...
                        <div className="relative mt-16 h-80 lg:mt-8">
                            <Image className="absolute left-0 top-0 w-[57rem] max-w-none rounded-md bg-white/5 ring-1 ring-white/10" src={StoreInfo.image} alt={StoreInfo.name} width="1824" height="1080">
                            </Image>
                        </div>
                    </div>
                </div>
